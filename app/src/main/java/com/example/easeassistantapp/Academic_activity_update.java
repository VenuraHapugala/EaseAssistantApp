...
public class Academic_activity_update extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(res.getCount()==0){
            Toast.makeText(Academic_activity_update.this, "no Entry Exists", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkupdatedata == true) {
                    Toast.makeText(Academic_activity_update.this, "Entry  update", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getBaseContext(), AcademicaddNote.class);
                    startActivity(intent);
                }
                else
                    Toast.makeText(Academic_activity_update.this, "New Entry Not Updated", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkdeletedata == true) {
                    Toast.makeText(Academic_activity_update.this, "Entry delete", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getBaseContext(), AcademicaddNote.class);
                    startActivity(intent);
                }
                else
                    Toast.makeText(Academic_activity_update.this, " Entry Not deleted", Toast.LENGTH_SHORT).show();
            }
        });
